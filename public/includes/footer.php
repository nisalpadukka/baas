    ...
    <footer class="main-footer">
            ...
            <div class="footer-widget-area clearfix">
                ...
                <article class="footer-widget about-widget col-md-3 col-sm-6 col-xs-12 wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1000ms">
                    ...
                    <div class="widget-content">
                        <p>One stop solution for the Sri Lankan public to meet, connect and communicate with the service providers in construction Industry</p>
                    </div>
                </article>
                ...
                <article class="footer-widget address col-md-3 col-sm-6 col-xs-12 wow fadeInUp" data-wow-delay="600ms" data-wow-duration="1000ms">
                    ...
                    <div class="widget-content">
                        <ul class="info">
                            <li><span class="fa fa-map-marker"></span> &ensp; 35, Reid Avenue, Colombo</li>
                            <li><span class="fa fa-phone"></span> &ensp;0776014365</li>
                            <li><span class="fa fa-envelope"></span> &ensp; <a href="mailto:info@companyname.com">admin@baas.lk</a></li>
                        </ul>
        ...
        <div class="footer-bottom">
            <div class="auto-container text-center"><a href="#"> Copyright © 2015-2016 baas.lk</a> </div>
        </div>
